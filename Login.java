...
public class Login extends JFrame {
  ...
  private FileSystem file = new FileSystem("database.txt");    
  private HashMap<String,String> database = file.fetchDatabase(); 
  ...
  public void signupPanel(){
    ...
    JPasswordField reconfirmField = new JPasswordField(); 
  ...
  public void login(){
    ...
    else  JOptionPane.showMessageDialog(null,"Invalid Login","INFO",JOptionPane.INFORMATION_MESSAGE); 
  }
